...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="main-page-content view" id="tblSticky">
		...
		<tr><td colspan='2'>
							<input type="text" name="owner" class="text-space" placeholder="Owner" style="width:80% !important;" required/>
		...
		<tr><td colspan='2' align="center" style="padding:2px 15px;"><a href="GetDummy" class="w3-button w3-green" style="text-decoration:none;">Generate Dummy</a></td></tr>
